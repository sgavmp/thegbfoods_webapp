...
MaterialSnackbar.prototype.createSnackbar_ = function() {
  ...
  if (this.actionHandler2_) {
	    this.actionElement2_ = document.createElement('button');
	    this.actionElement2_.type = 'button';
	    this.actionElement2_.classList.add(this.cssClasses_.action);
	    this.actionElement2_.textContent = this.actionText2_;
	    this.snackbarElement_.appendChild(this.actionElement2_);
	    this.actionElement2_.addEventListener('click', this.actionHandler2_);
	  }
  
  if (this.cssColor_) {
	  this.textElement_.classList.add(this.cssColor_);
  }
...
MaterialSnackbar.prototype.showSnackbar = function(data) {
  ...
  if (this.active) {
    ...
    if (data.actionHandler2) {
        this.actionHandler2_ = data.actionHandler2;
      }
      if (data.actionText2) {
        this.actionText2_ = data.actionText2;
      }
